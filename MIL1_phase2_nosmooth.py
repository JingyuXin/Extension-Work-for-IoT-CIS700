...
# Train a MIL-Siamese model on non-smoothed data to detect non-pure data
...
if __name__ == '__main__':
    print("This is a testing using balanced dataset without smoothing.")
    ...
    #out = '/home/jxin05/MILtrainingDirect/'

    out = '/home/jxin05/newCode/MIL1/nosmooth/6pairs/'
